...
int main() {
	...
	cout << "\n1. stop words 제거 전\n";
	cout << "``````````````````````````\n";
	NaiveBayesClassifier nb1(Max_n, Min_p, train_data, voca_data, "");
	...
	cout << num << " 가장 중요한 단어:\n";
	words = nb1.most_important(num, false);
	for (ll i = 0; i < num; i++) {
		cout << words[i] << " ";
	}
	cout << "\n";
	...
	cout << "Time : " << setprecision(4) << ((clock() - t) / static_cast<double>(CLOCKS_PER_SEC)) << " seconds\n";
	cout << num << " 가장 중요한 단어:\n";
	words = nb1.most_important(num, true);
	for (ll i = 0; i < num; i++) {
		cout << words[i] << " ";
	}
	cout << "\n";
	...
	cout << "\nstop words 제거 후\n";
	cout << "````````````````````````\n";
	NaiveBayesClassifier nb2(Max_n, Min_p, train_data, voca_data, sw_data);
	...
	cout << "Time : " << setprecision(4) << ((clock() - t) / static_cast<double>(CLOCKS_PER_SEC)) << " seconds\n";
	cout << num << " 가장 중요한 단어:\n";
	words = nb2.most_important(num, false);
	for (ll i = 0; i < num; i++) {
		cout << words[i] << " ";
	}
	cout << "\n";
	...
	cout << "Time : " << setprecision(4) << ((clock() - t) / static_cast<double>(CLOCKS_PER_SEC)) << " seconds\n";
	cout << num << " 가장 중요한 단어:\n";
	words = nb2.most_important(num, true);
	for (ll i = 0; i < num; i++) {
		cout << words[i] << " ";
	}
	cout << "\n\n";
